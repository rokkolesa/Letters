...
\begin{tikzpicture}
  ...
  \begin{tabular}{c c}
        ...
        \multicolumn{2}{c}{Fig 2: Betti numbers for dimensions 0 and 1, no rotation}
  
  \end{tabular}
  
  \begin{tabular}{c c}
          \includegraphics[scale=0.6]{../images/0D_45deg.pdf}
          &
          \includegraphics[scale=0.6]{../images/0D_90deg.pdf}\\
          \multicolumn{2}{c}{Fig 3: Betti numbers for dimension 0, rotated for 45 and 90 degrees.}
    
   \end{tabular}
   
   \centering
   \begin{tabular}{c}
             \includegraphics[scale=0.9]{../images/0D_180deg.pdf}\\
             \multicolumn{1}{c}{Fig 4: Betti numbers for dimension 0, rotated for 180 degrees.}
...
\end{enumerate}
  ...
  \blocknode{Decision tree}{
    \centering
       \begin{tabular}{c}
                 ...
                 \multicolumn{1}{c}{Fig 5: Letter decision tree}
  ...
  \blocknode{Results}%
  {
  \coloredbox{colorthree!50!}{With described method we were able to successfully classify input data.  
